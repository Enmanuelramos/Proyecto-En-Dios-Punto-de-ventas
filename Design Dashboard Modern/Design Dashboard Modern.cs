...
namespace Design_Dashboard_Modern
{
    public partial class Form1 : Form
    {
        ...
        {
            Form_Agregar_Productos AddProduct = new Form_Agregar_Productos();

            var frm = Application.OpenForms.OfType<Form_Agregar_Productos>().FirstOrDefault();
            ...
            if (frm != null)
            {
                MessageBox.Show("el formulario Carrito esta abierto");
