...
namespace Microsell_Lite.Compras
{
    public partial class Frm_Compras : Form
    {
        ...
        private void Configurar_ListVew()
        {
            ...
            ListvewDetalle.Columns.Add("", 80, HorizontalAlignment.Left);//0
            ListvewDetalle.Columns.Add("", 377, HorizontalAlignment.Left);//1
            ListvewDetalle.Columns.Add("", 80, HorizontalAlignment.Left);//2
            ListvewDetalle.Columns.Add("", 90, HorizontalAlignment.Right);//3
            ListvewDetalle.Columns.Add("", 90, HorizontalAlignment.Right);//5

        }
        private void Llenar_Combo_Proveedor()
        {
           
            RN_Proveedores ProVer = new RN_Proveedores();
            DataTable Datos = new DataTable();

            Datos = ProVer.RN_Mostrar_Proveedor();
