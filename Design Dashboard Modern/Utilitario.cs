...
namespace Design_Dashboard_Modern
{
    class Utilitario
    {
        ...
        public int Solo_Numeros(int Numeros)
        {
            switch (Numeros)
            {
                case 48:
                ...
                case 44: 
                    return Numeros;
                default:
                    MessageBox.Show("No se Permite Letras", "Advertencia de Validacfion", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    break;
            }
            return Numeros = 0;
        }

        internal int Solo_Numeros(object keyChar)
        {
