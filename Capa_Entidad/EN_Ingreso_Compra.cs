...
namespace Capa_Entidad
{
    public  class EN_Ingreso_Compra
    {
        ...
        public string SubTotal_Com { get => _SubTotal_Com; set => _SubTotal_Com = value; }
        public DateTime FechaIngre { get => _FechaIngre; set => _FechaIngre = value; }
        public string TotalCompra { get => _TotalCompra; set => _TotalCompra = value; }
